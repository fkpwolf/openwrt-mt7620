...
#define RalinkRT5592_PROC_DIR_NAME "ralink_5g"
#define RalinkRT5592_PROC_VERSION "version_5g"
#define RalinkRT5592_PROC_VERSION_DATE "date_5g"
...
int RalinkRT5592_proc_init(void)
{
	...
	if(ralink_proc_directory){
		...
		if ((ralink_proc_version_date = create_proc_entry(RalinkRT5592_PROC_VERSION_DATE, 0, ralink_proc_directory))){
...
int RalinkRT5592_proc_cleanup(void)
{

	if(ralink_proc_directory)
	{
		if(ralink_proc_version){
			remove_proc_entry(RalinkRT5592_PROC_VERSION,ralink_proc_directory);
			ralink_proc_version =NULL;
		}
		if(ralink_proc_version_date){
			remove_proc_entry(RalinkRT5592_PROC_VERSION_DATE,ralink_proc_directory);
			ralink_proc_version_date = NULL;		
		}
		remove_proc_entry(RalinkRT5592_PROC_DIR_NAME, NULL);
